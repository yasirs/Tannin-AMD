...
|----------|-------------------|---------|-------------------|------------|--------|
| **Age** | 21 | 0.055 | **1.0e-15** | 0.153 | ✓ Significant |
| **Redox** | 11 | 0.028 | **5.7e-6** | 0.144 | ✓ Significant |
| **Inflammation** | 9 | 0.023 | **1.9e-4** | -0.001 | ✓ Overlap significant |
...
### AMD Signatures
Low coverage for AMD gene sets reflects tissue-specific expression patterns in RPE that differ from cancer cell lines. AMD-specific findings should be interpreted cautiously.
